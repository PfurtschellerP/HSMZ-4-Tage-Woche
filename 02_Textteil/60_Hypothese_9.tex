...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.7\textwidth]{04_Artefakte/01_Abbildungen/hypothese_9/bereitschaft_alter.png}
%     \caption{Verteilung der Antworten zur Bereitschaft zu Weiterbildung der Arbeitnehmenden unter Berücksichtigung des Alters}
